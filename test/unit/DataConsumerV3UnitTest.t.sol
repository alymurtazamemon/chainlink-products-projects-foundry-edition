...
import {DeployDataConsumerV3, DataConsumerV3, DataConsumerV3_HelperConfig} from "../../script/deploy/DeployDataConsumerV3.s.sol";

contract DataConsumerV3UnitTest is Test {
    DataConsumerV3 consumer;
    DataConsumerV3_HelperConfig helperConfig;
